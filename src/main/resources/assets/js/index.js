    ...
    if (resources.length < 1) {
        ...
        $.each(resources, function (i, resource) {
            ...
            contentHtml += "<div class='row content-box rounded' data-id='" + resource.id + "'><div class='col-12 col-sm-12'><br/><div class='row'>" +
                ...
                ("#uploaded-content" === tabId ? "&emsp;<a href='javascript:;' class='font-1' onclick='editFile();'>编辑</a>&emsp;<a href='http://127.0.0.1:8012/onlinePreview?url=" + encodeURIComponent('C:\\Users\\dongf\\Desktop\\uploaddemo\\' + resource.fileName ) +"' >预览</a>&emsp;<a href='javascript:;' class='font-1' onclick='removeFile();'>删除</a>" : "") +
